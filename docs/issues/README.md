...
| [IF-123](./IF-123.md) | P2 | Resolved | CLI/replica safety | Replica mode trusts backend labels instead of actual SQL dialects |
| [IF-124](./IF-124.md) | P2 | Resolved | MCP/framing | MCP stdio drops partially consumed frames on select cancellation |
...
| [IF-127](./IF-127.md) | P2 | Resolved | ArangoDB/pagination | Arango cursor IDs are discarded |
| [IF-128](./IF-128.md) | P2 | Resolved | AI/chunking | Semantic chunking selects minima of a distance signal |
