...
Nodes are registered in a `NodeRegistry` and exposed to Lua as callable factory functions. 28 built-in nodes are provided across HTTP, shell, file, data transform, conditional, timing, code execution, and utility categories.
