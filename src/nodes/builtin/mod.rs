...
pub fn register_all(registry: &mut NodeRegistry) {
    ...
    registry.register(Arc::new(s3vector_node::S3VectorCreateBucketNode));
    registry.register(Arc::new(s3vector_node::S3VectorGetBucketNode));
    registry.register(Arc::new(s3vector_node::S3VectorCreateIndexNode));
    registry.register(Arc::new(s3vector_node::S3VectorGetIndexNode));
    registry.register(Arc::new(s3vector_node::S3VectorPutVectorsNode));
    registry.register(Arc::new(s3vector_node::S3VectorQueryVectorsNode));
    registry.register(Arc::new(s3vector_node::S3VectorDeleteVectorsNode));
